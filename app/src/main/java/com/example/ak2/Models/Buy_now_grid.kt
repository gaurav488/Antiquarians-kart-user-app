...
class Buy_now_grid {
    ...
    constructor(prod_images: String, product_name: String, Product_Price :String,url:String,product_id:String,product_description:String,category: String,Uid:String) {
